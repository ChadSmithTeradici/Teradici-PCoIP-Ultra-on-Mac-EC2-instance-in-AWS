...
1. When the PCoIP client starts, it will ask for a **Host Address or Code**. Enter in your IP address or FQDN previously identified in previous section. (optionally) enter a name to **Connection Name** field, if you want to save connection.
